...
dew_point = st.number_input(" Dew Point (°C)", -20.0, 30.0, 10.0)
cloud_cover = st.number_input(" Cloud Cover (%)", 0.0, 100.0, 50.0)
uv_index = st.number_input(" UV Index", 0.0, 15.0, 5.0)
precipitation = st.number_input(" Precipitation (mm)", 0.0, 500.0, 0.0)
solar_radiation = st.number_input(" Solar Radiation (W/m²)", 0.0, 1500.0, 400.0)
